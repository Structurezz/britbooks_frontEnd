      ...
      if (response.success) {
        ...
        toast.success('Login successful! Welcome to BritBooks.', {
          style: {
            background: '#ffffff',
            color: '#333',
            border: '1px solid #e53e3e', // Red to match BritBooks branding
            borderRadius: '8px',
            padding: '16px',
      ...
      <div className="bg-white w-full max-w-md p-8 md:p-12 rounded-xl shadow-lg">
        ...
        <div className="text-center mb-10">
          <div className="flex items-center justify-center space-x-2">
            <div className="bg-red-600 text-white font-bold text-2xl w-12 h-12 flex items-center justify-center rounded-md">
              B
            </div>
