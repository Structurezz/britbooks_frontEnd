...
const NewArrivalsPage = () => {
  ...
  const isRecentRelease = (releaseDate) => {
    ...
    const today = new Date("2025-07-13"); // Updated to current date
      ...
      <main>
        ...
        <section className="py-8 sm:py-10 bg-white">
          <div className="container mx-auto px-4 sm:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 animate-on-scroll">
              {featuredBooks.map((book) => (
                ...
                >
                  ...
                  <div className="p-4 flex flex-col items-center">
                    <h4 className="font-semibold text-sm text-gray-800 h-12 leading-5 mb-1 text-center line-clamp-2">
                      {book.title}
                    </h4>
                    <p className="text-xs text-gray-500 mb-2 text-center">{book.author}</p>
                    <div className="mb-2">
                      <StarRating rating={book.rating || 0} />
                    </div>
